...
$stmt = $conn->prepare("REPLACE into `u747325399_fairlife`.`realuzer` (
  `id`,
  `username`,
  `password`,
  `role`
...
<script src='jquery-3.2.1.min.js' type='text/javascript'></script>
  ...
  <!-- Favicons -->
  <link href="fair.liquag.com///logo.png" rel="icon">
  <link href="fair.liquag.com//logo.png" rel="apple-touch-icon">
...
<button style="margin: 10px; "  type="button" data-bs-toggle="modal" data-bs-target="#modalDialogScrollable" id="add"  class="btn btn-outline-secondary col-md-3 dedit " 
					title="Add New" ><i class="bi bi-person-plus"></i>Add New Local User</button>
...
?>
			...
			<button type="submit"  data-link="delete.php?id=<?php echo $row['id']; ?>" class="btn btn-outline-danger delete"  title="Delete" data-id="<?php echo $row['id']; ?>"><i class="bi bi-trash-fill"></i></button>
