...
?>
                  <tr>
					...
					<td>
			<button type="button" data-link="edit.php?id=<?php echo $row['MemberID']; ?>" class="btn btn-outline-primary approve"  title="Approve" data-id="<?php echo $row['MemberID']; ?>"><i class="bi bi-check-all"></i></button>
			<button type="button" data-link="dedit.php?id=<?php echo $row['MemberID']; ?>" class="btn btn-outline-secondary delete"  title="Delete" data-id="<?php echo $row['MemberID']; ?>"><i class="bi bi-trash"></i></button>
