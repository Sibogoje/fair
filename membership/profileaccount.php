...
<div class="card col-lg-12" style="">
            <div class="card-body">
			  ...
			  <form class="row g-3 needs-validation" id="user_form" method="post" action="profileaccountprint.php" target="_blank"  enctype="multipart/form-data" novalidate>
  ...
  <div class="text-center">
                  <button type="submit" class="btn btn-warning" name="printprofile" data-id="rr"  style="width: 100%;">Print Profile Account</button>
               </div>
		  ...
		  <div class="card col-lg-12" style="">
            <div class="card-body">
			  ...
			  <form class="row g-3 needs-validation" id="fff" method="post" action="" target="" enctype="multipart/form-data" novalidate>
			     ...
			     <div class="text-center">
                  <button type="buttton" name="ggg" class="btn btn-success direct" id=""  style="width: 100%;"><b>Beneficiary Account Preview</b></button>
               </div>
