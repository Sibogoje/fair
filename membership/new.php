...
?>
          ...
          <div class="form-floating">
				  ...
				  <div class="col-md-3">
                  <div class="form-floating">
                    <input type="text" class="form-control" id="ff" placeholder="Approved Benefit" name="ApprovedBenefit" required>
          ...
          <div class="col-md-3">
                  ...
                  <div class="form-floating">
                    <textarea class="form-control" placeholder="Address" id="floatingTextarea" name="Comments" style="height: 100px;"></textarea>
