...
$activeresult = mysqli_query($conn, 'SELECT ttactive FROM mbrs_active'); 
...
//$result = mysqli_query($conn, "SELECT SUM(NewBalance) AS value_sum FROM fundsum WHERE `Terminated`='0'"); 
...
?>
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6><?php //echo "E ".number_format($sum = $row['value_sum'], 2); ?></h6>
                      <span class="text-danger small pt-1 fw-bold">12%</span> <span class="text-muted small pt-2 ps-1">decrease from Yesterday</span>
