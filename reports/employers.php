...
<div class="card col-lg-12" style="">
            <div class="card-body">
              <h5 class="card-title">Choose Employer</h5>
			  
			  <form class="row g-3 needs-validation" id="user_form" method="post"  enctype="multipart/form-data" novalidate>
			   ...
			   <div class="col-md-6">
                  ...
                  <div class="form-floating">
					...
					<option value="" selected></option>
						<?php 
						$stmt12 = $conn->prepare("SELECT DISTINCT * FROM `tblemployers1` ");
						$stmt12->execute();
						$result12 = $stmt12->get_result();
						if ($result12->num_rows > 0) {
						  // output data of each row
						while($row12 = $result12->fetch_assoc()) {
						$MemberNo = $row12['employerID'];
						//$retirementfund = $row12['RetirementFundID'];
					    	
							

						?>
					<option value="<?php echo $row12['employerID']; ?>"><?php echo $row12['employerID']." - ".$row12['EmployerName'] ; ?></option>
						<?php   }
						} else {
						  echo "0 results";
						} ?> 
        ...
        <br/>
                ...
                <div class="col-md-3">
                  ...
                  <button type="button"  class="btn btn-warning add" id="addreport" data-link="" data-id="rr"  style="width: 100%;"><b>View Member Summary</b></button>
               </div>
            ...
            <div class="card-body">
			  ...
			  <form class="row g-3 needs-validation" id="user_form" method="post" action="" target="_blank" enctype="multipart/form-data" novalidate>
			     ...
			     <div class="text-center">
                  <button type="button" name="viewport" class="btn btn-success direct" id="viewreport"  style="width: 100%;"><b>Annexure</b></button>
               </div>
