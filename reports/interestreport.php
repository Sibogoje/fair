...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Interest Transaction Report</h1>
      <nav>
        <ol class="breadcrumb">
...
<div class="card col-lg-12" style="">
            <div class="card-body">
              <h5 class="card-title">Choose Period</h5>
			  
			  <form class="row g-3 needs-validation" id="user_form" method="post" action="interestcsv.php"  enctype="multipart/form-data" novalidate>
