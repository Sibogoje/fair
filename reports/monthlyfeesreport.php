...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Admin & Monthly fees Transaction Report</h1>
      <nav>
        <ol class="breadcrumb">
...
<div class="card col-lg-12" style="">
            <div class="card-body">
			  ...
			  <form class="row g-3 needs-validation" id="user_form" method="post" action="monthlyfeescsv.php"  enctype="multipart/form-data" novalidate>
